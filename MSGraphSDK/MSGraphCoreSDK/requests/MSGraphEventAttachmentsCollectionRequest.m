...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphEventAttachmentsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphEventAttachmentsCollectionRequest *nextRequest = [[MSGraphEventAttachmentsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
