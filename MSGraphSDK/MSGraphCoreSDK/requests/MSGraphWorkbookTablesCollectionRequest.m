...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphWorkbookTablesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphWorkbookTablesCollectionRequest *nextRequest = [[MSGraphWorkbookTablesCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
