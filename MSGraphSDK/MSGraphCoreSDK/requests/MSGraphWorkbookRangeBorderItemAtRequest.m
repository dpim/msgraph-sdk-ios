...
@interface MSGraphWorkbookRangeBorderItemAtRequest()
...
@implementation MSGraphWorkbookRangeBorderItemAtRequest
...
- (MSURLSessionDataTask *)executeWithCompletion:(void (^)(MSGraphWorkbookRangeBorder *response, NSError *error))completionHandler
{

    MSURLSessionDataTask *task = [self taskWithRequest:self.mutableRequest
                                odObjectWithDictionary:^(id responseObject){
                                                           return [[MSGraphWorkbookRangeBorder alloc] initWithDictionary:responseObject];
                                                       }
