...
@implementation MSGraphSharesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphSharesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphSharesCollectionRequest *nextRequest = [[MSGraphSharesCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
