...
@implementation MSGraphUserDrivesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphUserDrivesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphUserDrivesCollectionRequest *nextRequest = [[MSGraphUserDrivesCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
