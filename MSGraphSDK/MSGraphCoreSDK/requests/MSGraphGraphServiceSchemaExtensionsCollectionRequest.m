...
@implementation MSGraphSchemaExtensionsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphSchemaExtensionsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphSchemaExtensionsCollectionRequest *nextRequest = [[MSGraphSchemaExtensionsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
