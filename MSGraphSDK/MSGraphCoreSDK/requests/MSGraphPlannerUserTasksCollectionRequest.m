...
@implementation MSGraphPlannerUserTasksCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphPlannerUserTasksCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphPlannerUserTasksCollectionRequest *nextRequest = [[MSGraphPlannerUserTasksCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
