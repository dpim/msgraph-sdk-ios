...
@implementation MSGraphDomainDnsCnameRecordRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphDomainDnsCnameRecord *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDomainDnsCnameRecord alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(MSGraphDomainDnsCnameRecord *)domainDnsCnameRecord
{
