...
@implementation MSGraphWorkbookChartSeriesRequest
...
- (NSMutableURLRequest *)update:(MSGraphWorkbookChartSeries *)workbookChartSeries
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[workbookChartSeries dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:workbookChartSeries]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphWorkbookChartSeries alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
