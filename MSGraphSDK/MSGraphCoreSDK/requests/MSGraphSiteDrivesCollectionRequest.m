...
@implementation MSGraphSiteDrivesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphSiteDrivesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphSiteDrivesCollectionRequest *nextRequest = [[MSGraphSiteDrivesCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
