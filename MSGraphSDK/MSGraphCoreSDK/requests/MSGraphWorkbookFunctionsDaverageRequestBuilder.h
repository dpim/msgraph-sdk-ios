...
@class MSGraphWorkbookFunctionsDaverageRequest;

@interface MSGraphWorkbookFunctionsDaverageRequestBuilder : MSRequestBuilder
...
- (MSGraphWorkbookFunctionsDaverageRequest *)requestWithOptions:(NSArray *)options;
