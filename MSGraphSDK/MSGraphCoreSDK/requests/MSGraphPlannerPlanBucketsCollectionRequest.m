...
@implementation MSGraphPlannerPlanBucketsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphPlannerPlanBucketsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphPlannerPlanBucketsCollectionRequest *nextRequest = [[MSGraphPlannerPlanBucketsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
