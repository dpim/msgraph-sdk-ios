...
@implementation MSGraphContactMultiValueExtendedPropertiesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphContactMultiValueExtendedPropertiesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphContactMultiValueExtendedPropertiesCollectionRequest *nextRequest = [[MSGraphContactMultiValueExtendedPropertiesCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
