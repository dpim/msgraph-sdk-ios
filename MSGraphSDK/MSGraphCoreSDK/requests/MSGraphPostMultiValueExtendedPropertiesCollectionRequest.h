...
typedef void (^MSGraphPostMultiValueExtendedPropertiesCollectionCompletionHandler)(MSCollection *response, MSGraphPostMultiValueExtendedPropertiesCollectionRequest *nextRequest, NSError *error);

@interface MSGraphPostMultiValueExtendedPropertiesCollectionRequest : MSCollectionRequest
