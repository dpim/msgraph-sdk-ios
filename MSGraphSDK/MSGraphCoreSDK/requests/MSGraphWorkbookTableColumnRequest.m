...
@implementation MSGraphWorkbookTableColumnRequest
...
- (NSMutableURLRequest *)update:(MSGraphWorkbookTableColumn *)workbookTableColumn
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[workbookTableColumn dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:workbookTableColumn]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphWorkbookTableColumn alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
