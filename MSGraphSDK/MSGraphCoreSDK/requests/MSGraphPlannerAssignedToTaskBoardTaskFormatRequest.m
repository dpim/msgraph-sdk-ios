...
@implementation MSGraphPlannerAssignedToTaskBoardTaskFormatRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphPlannerAssignedToTaskBoardTaskFormat *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphPlannerAssignedToTaskBoardTaskFormat alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(MSGraphPlannerAssignedToTaskBoardTaskFormat *)plannerAssignedToTaskBoardTaskFormat
{
