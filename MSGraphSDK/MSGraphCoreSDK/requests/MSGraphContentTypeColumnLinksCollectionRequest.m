...
@implementation MSGraphContentTypeColumnLinksCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphContentTypeColumnLinksCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            return [[MSGraphColumnLink alloc] initWithDictionary:response];
                                         }
                                                        completion:^(MSCollection *collectionResponse, NSError *error){
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphContentTypeColumnLinksCollectionRequest *nextRequest = [[MSGraphContentTypeColumnLinksCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
...
- (NSMutableURLRequest *)addColumnLink:(MSGraphColumnLink*)columnLink
{
