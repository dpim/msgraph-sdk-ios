...
@interface MSGraphDriveSearchRequest()
...
@implementation MSGraphDriveSearchRequest
...
- (MSURLSessionDataTask *)executeWithCompletion:(void (^)(MSCollection *response, MSGraphDriveSearchRequest *nextRequest, NSError *error))completionHandler
{
    ...
    MSURLSessionDataTask *task = [self collectionTaskWithRequest:self.mutableRequest
                                      ...
                                      if(!error && collectionResponse.nextLink && completionHandler){
                                              MSGraphDriveSearchRequest *nextRequest = [[MSGraphDriveSearchRequest alloc] initWithURL:collectionResponse.nextLink
                                                                                                                  options:nil
                                                                                                                  client:self.client];
