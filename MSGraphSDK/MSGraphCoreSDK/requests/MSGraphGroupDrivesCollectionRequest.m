...
@implementation MSGraphGroupDrivesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphGroupDrivesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphGroupDrivesCollectionRequest *nextRequest = [[MSGraphGroupDrivesCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
