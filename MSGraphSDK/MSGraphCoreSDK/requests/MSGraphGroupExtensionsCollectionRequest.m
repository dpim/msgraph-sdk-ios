...
@implementation MSGraphGroupExtensionsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphGroupExtensionsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphGroupExtensionsCollectionRequest *nextRequest = [[MSGraphGroupExtensionsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
