...
@implementation MSGraphOnenoteEntitySchemaObjectModelRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphOnenoteEntitySchemaObjectModel *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphOnenoteEntitySchemaObjectModel alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(MSGraphOnenoteEntitySchemaObjectModel *)onenoteEntitySchemaObjectModel
{
