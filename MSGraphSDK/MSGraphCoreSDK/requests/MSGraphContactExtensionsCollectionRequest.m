...
@implementation MSGraphContactExtensionsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphContactExtensionsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphContactExtensionsCollectionRequest *nextRequest = [[MSGraphContactExtensionsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
