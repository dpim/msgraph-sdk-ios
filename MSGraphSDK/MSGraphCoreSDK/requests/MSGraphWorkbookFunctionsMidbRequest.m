...
@interface MSGraphWorkbookFunctionsMidbRequest()
...
@implementation MSGraphWorkbookFunctionsMidbRequest


- (instancetype)initWithText:(MSGraphJson *)text startNum:(MSGraphJson *)startNum numBytes:(MSGraphJson *)numBytes URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{
