...
@implementation MSGraphPlannerGroupPlansCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphPlannerGroupPlansCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphPlannerGroupPlansCollectionRequest *nextRequest = [[MSGraphPlannerGroupPlansCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
