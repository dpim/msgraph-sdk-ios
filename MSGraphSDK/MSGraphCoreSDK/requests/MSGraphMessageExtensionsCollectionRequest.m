...
@implementation MSGraphMessageExtensionsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphMessageExtensionsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphMessageExtensionsCollectionRequest *nextRequest = [[MSGraphMessageExtensionsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
