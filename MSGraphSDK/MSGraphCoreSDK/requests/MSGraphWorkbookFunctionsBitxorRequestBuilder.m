...
@interface MSGraphWorkbookFunctionsBitxorRequestBuilder()
...
@implementation MSGraphWorkbookFunctionsBitxorRequestBuilder
...
- (MSGraphWorkbookFunctionsBitxorRequest *)requestWithOptions:(NSArray *)options
{
    ...
    return [[MSGraphWorkbookFunctionsBitxorRequest alloc] initWithNumber1:self.number1
