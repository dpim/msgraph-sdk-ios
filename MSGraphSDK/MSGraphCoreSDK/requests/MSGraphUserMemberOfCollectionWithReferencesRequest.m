...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphUserMemberOfCollectionWithReferencesCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphUserMemberOfCollectionWithReferencesRequest *nextRequest = [[MSGraphUserMemberOfCollectionWithReferencesRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
