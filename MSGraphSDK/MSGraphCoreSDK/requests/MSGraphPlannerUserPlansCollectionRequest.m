...
@implementation MSGraphPlannerUserPlansCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphPlannerUserPlansCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphPlannerUserPlansCollectionRequest *nextRequest = [[MSGraphPlannerUserPlansCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
