...
@implementation MSGraphOnenoteSectionRequest
...
- (NSMutableURLRequest *)update:(MSGraphOnenoteSection *)onenoteSection
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[onenoteSection dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:onenoteSection]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphOnenoteSection alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
