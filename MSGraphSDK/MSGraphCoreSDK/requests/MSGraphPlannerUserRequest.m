...
@implementation MSGraphPlannerUserRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphPlannerUser *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphPlannerUser alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(MSGraphPlannerUser *)plannerUser
{
