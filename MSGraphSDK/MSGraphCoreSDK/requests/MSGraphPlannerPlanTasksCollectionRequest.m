...
@implementation MSGraphPlannerPlanTasksCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphPlannerPlanTasksCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphPlannerPlanTasksCollectionRequest *nextRequest = [[MSGraphPlannerPlanTasksCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
