...
@implementation MSGraphSiteColumnsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphSiteColumnsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphSiteColumnsCollectionRequest *nextRequest = [[MSGraphSiteColumnsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
