...
@implementation MSGraphWorkbookPivotTableRequest
...
- (NSMutableURLRequest *)update:(MSGraphWorkbookPivotTable *)workbookPivotTable
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[workbookPivotTable dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:workbookPivotTable]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphWorkbookPivotTable alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
