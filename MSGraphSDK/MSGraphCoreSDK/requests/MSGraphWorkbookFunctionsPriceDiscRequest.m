...
@interface MSGraphWorkbookFunctionsPriceDiscRequest()
...
@implementation MSGraphWorkbookFunctionsPriceDiscRequest


- (instancetype)initWithSettlement:(MSGraphJson *)settlement maturity:(MSGraphJson *)maturity discount:(MSGraphJson *)discount redemption:(MSGraphJson *)redemption basis:(MSGraphJson *)basis URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{
