...
@implementation MSGraphCalendarSingleValueExtendedPropertiesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphCalendarSingleValueExtendedPropertiesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphCalendarSingleValueExtendedPropertiesCollectionRequest *nextRequest = [[MSGraphCalendarSingleValueExtendedPropertiesCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
