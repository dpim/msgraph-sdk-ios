...
@implementation MSGraphWorkbookRangeBorderRequest
...
- (NSMutableURLRequest *)update:(MSGraphWorkbookRangeBorder *)workbookRangeBorder
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[workbookRangeBorder dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:workbookRangeBorder]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphWorkbookRangeBorder alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
