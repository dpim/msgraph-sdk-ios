...
@implementation MSGraphDeviceExtensionsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphDeviceExtensionsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphDeviceExtensionsCollectionRequest *nextRequest = [[MSGraphDeviceExtensionsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
