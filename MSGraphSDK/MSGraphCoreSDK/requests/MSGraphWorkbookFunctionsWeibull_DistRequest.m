...
@interface MSGraphWorkbookFunctionsWeibull_DistRequest()
...
@implementation MSGraphWorkbookFunctionsWeibull_DistRequest


- (instancetype)initWithX:(MSGraphJson *)x alpha:(MSGraphJson *)alpha beta:(MSGraphJson *)beta cumulative:(MSGraphJson *)cumulative URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{
