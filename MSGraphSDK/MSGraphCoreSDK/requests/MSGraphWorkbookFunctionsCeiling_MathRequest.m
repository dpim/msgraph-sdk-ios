...
@interface MSGraphWorkbookFunctionsCeiling_MathRequest()
...
@implementation MSGraphWorkbookFunctionsCeiling_MathRequest


- (instancetype)initWithNumber:(MSGraphJson *)number significance:(MSGraphJson *)significance mode:(MSGraphJson *)mode URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{
