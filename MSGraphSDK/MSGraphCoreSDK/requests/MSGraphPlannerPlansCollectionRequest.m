...
@implementation MSGraphPlannerPlansCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphPlannerPlansCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphPlannerPlansCollectionRequest *nextRequest = [[MSGraphPlannerPlansCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
