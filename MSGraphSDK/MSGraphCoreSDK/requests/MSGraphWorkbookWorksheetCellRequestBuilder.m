...
@interface MSGraphWorkbookWorksheetCellRequestBuilder()
...
@implementation MSGraphWorkbookWorksheetCellRequestBuilder
...
- (MSGraphWorkbookWorksheetCellRequest *)requestWithOptions:(NSArray *)options
{
    ...
    return [[MSGraphWorkbookWorksheetCellRequest alloc] initWithRow:self.row
                                                             column:self.column
                                                                URL:self.requestURL
                                                            options:options
                                                             client:self.client];
