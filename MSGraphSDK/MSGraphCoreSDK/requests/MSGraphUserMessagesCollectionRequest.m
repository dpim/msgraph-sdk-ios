...
@implementation MSGraphUserMessagesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphUserMessagesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphUserMessagesCollectionRequest *nextRequest = [[MSGraphUserMessagesCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
