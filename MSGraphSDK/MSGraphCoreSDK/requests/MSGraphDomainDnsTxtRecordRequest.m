...
@implementation MSGraphDomainDnsTxtRecordRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphDomainDnsTxtRecord *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDomainDnsTxtRecord alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(MSGraphDomainDnsTxtRecord *)domainDnsTxtRecord
{
