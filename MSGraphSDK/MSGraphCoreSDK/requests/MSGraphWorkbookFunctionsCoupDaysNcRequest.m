...
@interface MSGraphWorkbookFunctionsCoupDaysNcRequest()
...
@implementation MSGraphWorkbookFunctionsCoupDaysNcRequest


- (instancetype)initWithSettlement:(MSGraphJson *)settlement maturity:(MSGraphJson *)maturity frequency:(MSGraphJson *)frequency basis:(MSGraphJson *)basis URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{
