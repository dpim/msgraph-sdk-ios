...
@implementation MSGraphDomainVerificationDnsRecordsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphDomainVerificationDnsRecordsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphDomainVerificationDnsRecordsCollectionRequest *nextRequest = [[MSGraphDomainVerificationDnsRecordsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
