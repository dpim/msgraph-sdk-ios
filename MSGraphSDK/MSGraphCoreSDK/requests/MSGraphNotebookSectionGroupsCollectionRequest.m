...
@implementation MSGraphNotebookSectionGroupsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphNotebookSectionGroupsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphNotebookSectionGroupsCollectionRequest *nextRequest = [[MSGraphNotebookSectionGroupsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
