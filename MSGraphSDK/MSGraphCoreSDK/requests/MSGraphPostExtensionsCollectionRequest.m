...
@implementation MSGraphPostExtensionsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphPostExtensionsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphPostExtensionsCollectionRequest *nextRequest = [[MSGraphPostExtensionsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
