...
@interface MSGraphWorkbookFunctionsWeekdayRequest()
...
@implementation MSGraphWorkbookFunctionsWeekdayRequest


- (instancetype)initWithSerialNumber:(MSGraphJson *)serialNumber returnType:(MSGraphJson *)returnType URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{
