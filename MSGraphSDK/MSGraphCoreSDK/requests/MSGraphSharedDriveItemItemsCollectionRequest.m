...
@implementation MSGraphSharedDriveItemItemsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphSharedDriveItemItemsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphSharedDriveItemItemsCollectionRequest *nextRequest = [[MSGraphSharedDriveItemItemsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
