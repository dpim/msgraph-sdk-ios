...
@interface MSGraphWorkbookFunctionsMatchRequest()
...
@implementation MSGraphWorkbookFunctionsMatchRequest


- (instancetype)initWithLookupValue:(MSGraphJson *)lookupValue lookupArray:(MSGraphJson *)lookupArray matchType:(MSGraphJson *)matchType URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{
