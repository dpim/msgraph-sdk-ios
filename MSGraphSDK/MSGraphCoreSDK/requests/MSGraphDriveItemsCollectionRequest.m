...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphDriveItemsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphDriveItemsCollectionRequest *nextRequest = [[MSGraphDriveItemsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
