...
@implementation MSGraphWorkbookTableRowRequest
...
- (NSMutableURLRequest *)update:(MSGraphWorkbookTableRow *)workbookTableRow
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[workbookTableRow dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:workbookTableRow]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphWorkbookTableRow alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
