...
@interface MSGraphWorkbookChartSeriesItemAtRequest()
...
@implementation MSGraphWorkbookChartSeriesItemAtRequest
...
- (MSURLSessionDataTask *)executeWithCompletion:(void (^)(MSGraphWorkbookChartSeries *response, NSError *error))completionHandler
{
    ...
    MSURLSessionDataTask *task = [self taskWithRequest:self.mutableRequest
                                odObjectWithDictionary:^(id responseObject){
                                                           return [[MSGraphWorkbookChartSeries alloc] initWithDictionary:responseObject];
                                                       }
