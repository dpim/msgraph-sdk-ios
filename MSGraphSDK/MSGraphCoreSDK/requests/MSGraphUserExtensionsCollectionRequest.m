...
@implementation MSGraphUserExtensionsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphUserExtensionsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphUserExtensionsCollectionRequest *nextRequest = [[MSGraphUserExtensionsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
