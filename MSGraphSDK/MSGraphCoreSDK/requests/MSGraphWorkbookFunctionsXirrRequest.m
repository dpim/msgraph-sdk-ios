...
@interface MSGraphWorkbookFunctionsXirrRequest()
...
@implementation MSGraphWorkbookFunctionsXirrRequest


- (instancetype)initWithValues:(MSGraphJson *)values dates:(MSGraphJson *)dates guess:(MSGraphJson *)guess URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{
