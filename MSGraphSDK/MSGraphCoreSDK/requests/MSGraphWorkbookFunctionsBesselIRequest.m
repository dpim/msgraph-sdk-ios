...
@interface MSGraphWorkbookFunctionsBesselIRequest()
...
@implementation MSGraphWorkbookFunctionsBesselIRequest


- (instancetype)initWithX:(MSGraphJson *)x n:(MSGraphJson *)n URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{
