...
@implementation MSGraphGroupEventsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphGroupEventsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphGroupEventsCollectionRequest *nextRequest = [[MSGraphGroupEventsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
