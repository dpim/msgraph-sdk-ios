...
@implementation MSGraphWorkbookRangeViewRequest
...
- (NSMutableURLRequest *)update:(MSGraphWorkbookRangeView *)workbookRangeView
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[workbookRangeView dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:workbookRangeView]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphWorkbookRangeView alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
