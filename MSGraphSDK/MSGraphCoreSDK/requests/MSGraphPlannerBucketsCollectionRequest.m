...
@implementation MSGraphPlannerBucketsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphPlannerBucketsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphPlannerBucketsCollectionRequest *nextRequest = [[MSGraphPlannerBucketsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
