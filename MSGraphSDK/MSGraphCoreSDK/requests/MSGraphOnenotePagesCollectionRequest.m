...
@implementation MSGraphOnenotePagesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphOnenotePagesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphOnenotePagesCollectionRequest *nextRequest = [[MSGraphOnenotePagesCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
