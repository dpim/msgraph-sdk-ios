...
@interface MSGraphWorkbookChartPointItemAtRequest()
...
@implementation MSGraphWorkbookChartPointItemAtRequest
...
- (MSURLSessionDataTask *)executeWithCompletion:(void (^)(MSGraphWorkbookChartPoint *response, NSError *error))completionHandler
{

    MSURLSessionDataTask *task = [self taskWithRequest:self.mutableRequest
                                odObjectWithDictionary:^(id responseObject){
                                                           return [[MSGraphWorkbookChartPoint alloc] initWithDictionary:responseObject];
                                                       }
