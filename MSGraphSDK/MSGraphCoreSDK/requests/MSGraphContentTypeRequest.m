...
@implementation MSGraphContentTypeRequest
...
- (NSMutableURLRequest *)update:(MSGraphContentType *)contentType
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[contentType dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:contentType]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphContentType alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
