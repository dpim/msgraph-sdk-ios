...
@implementation MSGraphDomainDnsRecordsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphDomainDnsRecordsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphDomainDnsRecordsCollectionRequest *nextRequest = [[MSGraphDomainDnsRecordsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
