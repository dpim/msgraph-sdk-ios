...
@interface MSGraphWorkbookFunctionsReptRequest()
...
@implementation MSGraphWorkbookFunctionsReptRequest


- (instancetype)initWithText:(MSGraphJson *)text numberTimes:(MSGraphJson *)numberTimes URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{
