...
@implementation MSGraphWorkbookChartRequest
...
- (NSMutableURLRequest *)update:(MSGraphWorkbookChart *)workbookChart
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[workbookChart dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:workbookChart]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphWorkbookChart alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
