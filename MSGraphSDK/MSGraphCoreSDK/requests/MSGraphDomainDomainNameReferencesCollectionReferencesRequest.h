...
typedef void (^MSGraphDomainDomainNameReferencesCollectionReferencesCompletionHandler)(MSCollection *response, MSGraphDomainDomainNameReferencesCollectionReferencesRequest *nextRequest, NSError *error);

@interface MSGraphDomainDomainNameReferencesCollectionReferencesRequest : MSCollectionRequest
