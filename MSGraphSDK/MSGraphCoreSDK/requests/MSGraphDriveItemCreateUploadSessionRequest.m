...
@interface MSGraphDriveItemCreateUploadSessionRequest()
...
@implementation MSGraphDriveItemCreateUploadSessionRequest
...
- (MSURLSessionDataTask *)executeWithCompletion:(void (^)(MSGraphUploadSession *response, NSError *error))completionHandler
{
    ...
    MSURLSessionDataTask *task = [self taskWithRequest:self.mutableRequest
                                odObjectWithDictionary:^(id responseObject){
                                                           return [[MSGraphUploadSession alloc] initWithDictionary:responseObject];
                                                       }
