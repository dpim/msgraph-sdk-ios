...
@implementation MSGraphWorkbookWorksheetTablesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphWorkbookWorksheetTablesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphWorkbookWorksheetTablesCollectionRequest *nextRequest = [[MSGraphWorkbookWorksheetTablesCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
