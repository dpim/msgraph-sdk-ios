...
@implementation MSGraphOnenoteSectionGroupsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphOnenoteSectionGroupsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphOnenoteSectionGroupsCollectionRequest *nextRequest = [[MSGraphOnenoteSectionGroupsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
