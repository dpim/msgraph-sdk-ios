...
@implementation MSGraphGroupRejectedSendersCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphGroupRejectedSendersCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphGroupRejectedSendersCollectionRequest *nextRequest = [[MSGraphGroupRejectedSendersCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
