...
- (NSArray*) columns
{
    ...
    if ([columns isKindOfClass:[NSArray class]]){
        for (id workbookTableColumn in columns){
            [columnsResult addObject:[[MSGraphWorkbookTableColumn alloc] initWithDictionary: workbookTableColumn]];
        }
    }
...
- (NSArray*) rows
{
    ...
    if ([rows isKindOfClass:[NSArray class]]){
        for (id workbookTableRow in rows){
            [rowsResult addObject:[[MSGraphWorkbookTableRow alloc] initWithDictionary: workbookTableRow]];
        }
    }
