...
- (NSArray*) notebooks
{
    ...
    if ([notebooks isKindOfClass:[NSArray class]]){
        for (id notebook in notebooks){
            [notebooksResult addObject:[[comNotebook alloc] initWithDictionary: notebook]];
        }
    }
...
- (NSArray*) resources
{
    ...
    if ([resources isKindOfClass:[NSArray class]]){
        for (id onenoteResource in resources){
            [resourcesResult addObject:[[comOnenoteResource alloc] initWithDictionary: onenoteResource]];
        }
    }
...
- (NSArray*) onenoteOperations
{
    ...
    if ([onenoteOperations isKindOfClass:[NSArray class]]){
        for (id onenoteOperation in onenoteOperations){
            [onenoteOperationsResult addObject:[[comOnenoteOperation alloc] initWithDictionary: onenoteOperation]];
        }
    }
