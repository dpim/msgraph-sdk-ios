...
@class comDomainState, comDomainDnsRecord, comDirectoryObject; 


#import "comEntity.h"

@interface comDomain : comEntity
  ...
  @property (nonnull, nonatomic, setter=setAuthenticationType:, getter=authenticationType) NSString* authenticationType;
    ...
    @property (nullable, nonatomic, setter=setState:, getter=state) comDomainState* state;
