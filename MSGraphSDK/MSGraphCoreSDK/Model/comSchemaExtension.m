...
@implementation comSchemaExtension
...
- (NSArray*) properties
{
    ...
    if ([properties isKindOfClass:[NSArray class]]){
        for (id extensionSchemaProperty in properties){
            [propertiesResult addObject:[[comExtensionSchemaProperty alloc] initWithDictionary: extensionSchemaProperty]];
        }
    }
