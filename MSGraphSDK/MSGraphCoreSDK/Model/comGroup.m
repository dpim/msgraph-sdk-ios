...
@interface comGroup()
{
    ...
    NSArray* _members;
    NSArray* _memberOf;
    comDirectoryObject* _createdOnBehalfOf;
    NSArray* _owners;
    NSArray* _settings;
    NSArray* _extensions;
    NSArray* _threads;
    ...
    NSArray* _drives;
    NSArray* _sites;
    comPlannerGroup* _planner;
    comOnenote* _onenote;
}
@end

@implementation comGroup
...
- (NSArray*) members
{
    ...
    if ([members isKindOfClass:[NSArray class]]){
        for (id directoryObject in members){
            [membersResult addObject:[[comDirectoryObject alloc] initWithDictionary: directoryObject]];
        }
    }
...
- (comDirectoryObject*) createdOnBehalfOf
{
    if(!_createdOnBehalfOf){
        _createdOnBehalfOf = [[comDirectoryObject alloc] initWithDictionary: self.dictionary[@"createdOnBehalfOf"]];
    }
    return _createdOnBehalfOf;
}

- (void) setCreatedOnBehalfOf: (comDirectoryObject*) val
{
...
- (NSArray*) owners
{
    ...
    if ([owners isKindOfClass:[NSArray class]]){
        for (id directoryObject in owners){
            [ownersResult addObject:[[comDirectoryObject alloc] initWithDictionary: directoryObject]];
        }
    }
...
- (NSArray*) settings
{
    ...
    if ([settings isKindOfClass:[NSArray class]]){
        for (id groupSetting in settings){
            [settingsResult addObject:[[comGroupSetting alloc] initWithDictionary: groupSetting]];
        }
    }
...
- (NSArray*) threads
{
    ...
    if ([threads isKindOfClass:[NSArray class]]){
        for (id conversationThread in threads){
            [threadsResult addObject:[[comConversationThread alloc] initWithDictionary: conversationThread]];
        }
    }
...
- (NSArray*) conversations
{
    ...
    if ([conversations isKindOfClass:[NSArray class]]){
        for (id conversation in conversations){
            [conversationsResult addObject:[[comConversation alloc] initWithDictionary: conversation]];
        }
    }
...
- (NSArray*) acceptedSenders
{
    ...
    if ([acceptedSenders isKindOfClass:[NSArray class]]){
        for (id directoryObject in acceptedSenders){
            [acceptedSendersResult addObject:[[comDirectoryObject alloc] initWithDictionary: directoryObject]];
        }
    }
...
- (NSArray*) rejectedSenders
{
    ...
    if ([rejectedSenders isKindOfClass:[NSArray class]]){
        for (id directoryObject in rejectedSenders){
            [rejectedSendersResult addObject:[[comDirectoryObject alloc] initWithDictionary: directoryObject]];
        }
    }
...
- (comPlannerGroup*) planner
{
    if(!_planner){
        _planner = [[comPlannerGroup alloc] initWithDictionary: self.dictionary[@"planner"]];
    }
    return _planner;
}

- (void) setPlanner: (comPlannerGroup*) val
{
    _planner = val;
