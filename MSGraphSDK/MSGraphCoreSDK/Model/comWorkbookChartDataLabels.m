...
@interface comWorkbookChartDataLabels()
{
    NSString* _position;
    NSString* _separator;
    ...
    BOOL _showValue;
    comWorkbookChartDataLabelFormat* _format;
}
@end

@implementation comWorkbookChartDataLabels
...
- (comWorkbookChartDataLabelFormat*) format
{
    if(!_format){
        _format = [[comWorkbookChartDataLabelFormat alloc] initWithDictionary: self.dictionary[@"format"]];
    }
    return _format;
}

- (void) setFormat: (comWorkbookChartDataLabelFormat*) val
{
    _format = val;
