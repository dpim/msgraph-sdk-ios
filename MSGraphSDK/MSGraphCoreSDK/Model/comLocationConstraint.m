...
@interface comLocationConstraint()
{
    BOOL _isRequired;
...
@implementation comLocationConstraint
...
- (NSArray*) locations
{
    ...
    if ([locations isKindOfClass:[NSArray class]]){
        for (id locationConstraintItem in locations){
            [locationsResult addObject:[[comLocationConstraintItem alloc] initWithDictionary: locationConstraintItem]];
        }
    }
