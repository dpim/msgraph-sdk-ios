...
@class comEmailAddress, comPhysicalAddress, comExtension, comSingleValueLegacyExtendedProperty, comMultiValueLegacyExtendedProperty, comProfilePhoto; 


#import "comOutlookItem.h"

@interface comContact : comOutlookItem
  ...
  @property (nullable, nonatomic, setter=setParentFolderId:, getter=parentFolderId) NSString* parentFolderId;
    ...
    @property (nullable, nonatomic, setter=setHomeAddress:, getter=homeAddress) comPhysicalAddress* homeAddress;
    @property (nullable, nonatomic, setter=setBusinessAddress:, getter=businessAddress) comPhysicalAddress* businessAddress;
    @property (nullable, nonatomic, setter=setOtherAddress:, getter=otherAddress) comPhysicalAddress* otherAddress;
