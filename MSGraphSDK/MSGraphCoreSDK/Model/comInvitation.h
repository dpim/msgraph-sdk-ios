...
@class comInvitedUserMessageInfo, comUser; 


#import "comEntity.h"

@interface comInvitation : comEntity
  ...
  @property (nullable, nonatomic, setter=setInvitedUserDisplayName:, getter=invitedUserDisplayName) NSString* invitedUserDisplayName;
    ...
    @property (nullable, nonatomic, setter=setInvitedUserMessageInfo:, getter=invitedUserMessageInfo) comInvitedUserMessageInfo* invitedUserMessageInfo;
    ...
    @property (nullable, nonatomic, setter=setInvitedUser:, getter=invitedUser) comUser* invitedUser;
