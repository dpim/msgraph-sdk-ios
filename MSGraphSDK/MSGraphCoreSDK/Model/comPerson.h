...
@class comScoredEmailAddress, comPhone, comLocation, comWebsite, comPersonType; 


#import "comEntity.h"

@interface comPerson : comEntity
  ...
  @property (nullable, nonatomic, setter=setDisplayName:, getter=displayName) NSString* displayName;
    ...
    @property (nullable, nonatomic, setter=setPersonType:, getter=personType) comPersonType* personType;
