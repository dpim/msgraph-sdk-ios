...
@class comLicenseUnitsDetail, comServicePlanInfo; 


#import "comEntity.h"

@interface comSubscribedSku : comEntity
  ...
  @property (nullable, nonatomic, setter=setCapabilityStatus:, getter=capabilityStatus) NSString* capabilityStatus;
    ...
    @property (nullable, nonatomic, setter=setPrepaidUnits:, getter=prepaidUnits) comLicenseUnitsDetail* prepaidUnits;
