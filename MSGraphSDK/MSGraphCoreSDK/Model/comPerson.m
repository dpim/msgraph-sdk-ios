...
@interface comPerson()
{
    ...
    comPersonType* _personType;
    NSString* _userPrincipalName;
    NSString* _imAddress;
}
@end

@implementation comPerson
...
- (NSArray*) scoredEmailAddresses
{
    ...
    if ([scoredEmailAddresses isKindOfClass:[NSArray class]]){
        for (id scoredEmailAddress in scoredEmailAddresses){
            [scoredEmailAddressesResult addObject:[[comScoredEmailAddress alloc] initWithDictionary: scoredEmailAddress]];
        }
    }
...
- (NSArray*) phones
{
    ...
    if ([phones isKindOfClass:[NSArray class]]){
        for (id phone in phones){
            [phonesResult addObject:[[comPhone alloc] initWithDictionary: phone]];
        }
    }
...
- (NSArray*) postalAddresses
{
    ...
    if ([postalAddresses isKindOfClass:[NSArray class]]){
        for (id location in postalAddresses){
            [postalAddressesResult addObject:[[comLocation alloc] initWithDictionary: location]];
        }
    }
...
- (NSArray*) websites
{
    ...
    if ([websites isKindOfClass:[NSArray class]]){
        for (id website in websites){
            [websitesResult addObject:[[comWebsite alloc] initWithDictionary: website]];
        }
    }
...
- (comPersonType*) personType
{
    if(!_personType){
        _personType = [[comPersonType alloc] initWithDictionary: self.dictionary[@"personType"]];
    }
    return _personType;
}

- (void) setPersonType: (comPersonType*) val
{
    _personType = val;
