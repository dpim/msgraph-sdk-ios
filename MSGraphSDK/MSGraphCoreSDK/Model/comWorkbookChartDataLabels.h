...
@class comWorkbookChartDataLabelFormat; 


#import "comEntity.h"

@interface comWorkbookChartDataLabels : comEntity
  ...
  @property (nullable, nonatomic, setter=setPosition:, getter=position) NSString* position;
    ...
    @property (nullable, nonatomic, setter=setFormat:, getter=format) comWorkbookChartDataLabelFormat* format;
