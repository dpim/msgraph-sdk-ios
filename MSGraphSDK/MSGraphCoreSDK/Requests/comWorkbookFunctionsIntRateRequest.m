...
@interface comWorkbookFunctionsIntRateRequest()
...
@implementation comWorkbookFunctionsIntRateRequest


- (instancetype)initWithSettlement:(comJson *)settlement maturity:(comJson *)maturity investment:(comJson *)investment redemption:(comJson *)redemption basis:(comJson *)basis URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{
