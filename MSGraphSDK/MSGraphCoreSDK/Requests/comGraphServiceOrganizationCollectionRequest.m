...
@implementation comOrganizationCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comOrganizationCollectionCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            return [[comOrganization alloc] initWithDictionary:response];
                                         }
                                                        completion:^(MSCollection *collectionResponse, NSError *error){
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comOrganizationCollectionRequest *nextRequest = [[comOrganizationCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
...
- (NSMutableURLRequest *)addOrganization:(comOrganization*)organization
{
