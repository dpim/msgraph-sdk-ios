...
@implementation comPostMultiValueExtendedPropertiesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comPostMultiValueExtendedPropertiesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comPostMultiValueExtendedPropertiesCollectionRequest *nextRequest = [[comPostMultiValueExtendedPropertiesCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
