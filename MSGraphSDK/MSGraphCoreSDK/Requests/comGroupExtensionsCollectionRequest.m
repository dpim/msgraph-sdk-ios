...
@implementation comGroupExtensionsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comGroupExtensionsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comGroupExtensionsCollectionRequest *nextRequest = [[comGroupExtensionsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
