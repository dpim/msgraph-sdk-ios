...
@implementation comPlannerProgressTaskBoardTaskFormatRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comPlannerProgressTaskBoardTaskFormat *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comPlannerProgressTaskBoardTaskFormat alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comPlannerProgressTaskBoardTaskFormat *)plannerProgressTaskBoardTaskFormat
{
