...
@implementation comEventExtensionsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comEventExtensionsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comEventExtensionsCollectionRequest *nextRequest = [[comEventExtensionsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
