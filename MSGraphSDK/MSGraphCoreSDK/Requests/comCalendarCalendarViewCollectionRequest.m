...
@implementation comCalendarCalendarViewCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comCalendarCalendarViewCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            return [[comEvent alloc] initWithDictionary:response];
                                         }
                                                        completion:^(MSCollection *collectionResponse, NSError *error){
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comCalendarCalendarViewCollectionRequest *nextRequest = [[comCalendarCalendarViewCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
...
- (NSMutableURLRequest *)addEvent:(comEvent*)event
{
