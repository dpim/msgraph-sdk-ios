...
@implementation comMessageExtensionsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comMessageExtensionsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comMessageExtensionsCollectionRequest *nextRequest = [[comMessageExtensionsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
