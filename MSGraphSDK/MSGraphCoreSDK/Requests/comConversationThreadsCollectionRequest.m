...
@implementation comConversationThreadsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comConversationThreadsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            return [[comConversationThread alloc] initWithDictionary:response];
                                         }
                                                        completion:^(MSCollection *collectionResponse, NSError *error){
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comConversationThreadsCollectionRequest *nextRequest = [[comConversationThreadsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
...
- (NSMutableURLRequest *)addConversationThread:(comConversationThread*)conversationThread
{
