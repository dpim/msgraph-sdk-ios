...
@implementation comWorkbookChartDataLabelsRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comWorkbookChartDataLabels *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comWorkbookChartDataLabels alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comWorkbookChartDataLabels *)workbookChartDataLabels
{
