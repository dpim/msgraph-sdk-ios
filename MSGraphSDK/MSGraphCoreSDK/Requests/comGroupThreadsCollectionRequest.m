...
@implementation comGroupThreadsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comGroupThreadsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comGroupThreadsCollectionRequest *nextRequest = [[comGroupThreadsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
