...
@interface comUserSendMailRequest()
...
@implementation comUserSendMailRequest


- (instancetype)initWithMessage:(comMessage *)message saveToSentItems:(BOOL)saveToSentItems URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{
