...
typedef void (^comDomainDomainNameReferencesCollectionReferencesCompletionHandler)(MSCollection *response, comDomainDomainNameReferencesCollectionReferencesRequest *nextRequest, NSError *error);

@interface comDomainDomainNameReferencesCollectionReferencesRequest : MSCollectionRequest
