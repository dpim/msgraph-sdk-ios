...
@implementation comDomainDnsSrvRecordRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comDomainDnsSrvRecord *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comDomainDnsSrvRecord alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comDomainDnsSrvRecord *)domainDnsSrvRecord
{
