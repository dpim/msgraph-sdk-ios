...
@implementation comEventInstancesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comEventInstancesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comEventInstancesCollectionRequest *nextRequest = [[comEventInstancesCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
