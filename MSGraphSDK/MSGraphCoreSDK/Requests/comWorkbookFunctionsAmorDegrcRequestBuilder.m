...
@interface comWorkbookFunctionsAmorDegrcRequestBuilder()
...
@implementation comWorkbookFunctionsAmorDegrcRequestBuilder
...
- (comWorkbookFunctionsAmorDegrcRequest *)requestWithOptions:(NSArray *)options
{
    ...
    return [[comWorkbookFunctionsAmorDegrcRequest alloc] initWithCost:self.cost
