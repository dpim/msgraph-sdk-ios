...
@interface comWorkbookFunctionsT_DistRequest()
...
@implementation comWorkbookFunctionsT_DistRequest


- (instancetype)initWithX:(comJson *)x degFreedom:(comJson *)degFreedom cumulative:(comJson *)cumulative URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{
