...
typedef void (^comContactSingleValueExtendedPropertiesCollectionCompletionHandler)(MSCollection *response, comContactSingleValueExtendedPropertiesCollectionRequest *nextRequest, NSError *error);

@interface comContactSingleValueExtendedPropertiesCollectionRequest : MSCollectionRequest
