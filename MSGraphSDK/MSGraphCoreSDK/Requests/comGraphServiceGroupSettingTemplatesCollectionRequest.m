...
@implementation comGroupSettingTemplatesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comGroupSettingTemplatesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            return [[comGroupSettingTemplate alloc] initWithDictionary:response];
                                         }
                                                        completion:^(MSCollection *collectionResponse, NSError *error){
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comGroupSettingTemplatesCollectionRequest *nextRequest = [[comGroupSettingTemplatesCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
...
- (NSMutableURLRequest *)addGroupSettingTemplate:(comGroupSettingTemplate*)groupSettingTemplate
{
