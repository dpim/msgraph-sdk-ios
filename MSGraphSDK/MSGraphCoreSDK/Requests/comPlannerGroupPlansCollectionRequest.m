...
@implementation comPlannerGroupPlansCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comPlannerGroupPlansCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comPlannerGroupPlansCollectionRequest *nextRequest = [[comPlannerGroupPlansCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
