...
@implementation comDirectoryObjectsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comDirectoryObjectsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comDirectoryObjectsCollectionRequest *nextRequest = [[comDirectoryObjectsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
