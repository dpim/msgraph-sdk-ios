...
@implementation comWorkbookFunctionResultRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comWorkbookFunctionResult *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comWorkbookFunctionResult alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comWorkbookFunctionResult *)workbookFunctionResult
{
