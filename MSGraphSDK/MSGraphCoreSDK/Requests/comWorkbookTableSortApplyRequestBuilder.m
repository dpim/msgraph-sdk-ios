...
@interface comWorkbookTableSortApplyRequestBuilder()
...
@implementation comWorkbookTableSortApplyRequestBuilder
...
- (comWorkbookTableSortApplyRequest *)requestWithOptions:(NSArray *)options
{
    ...
    return [[comWorkbookTableSortApplyRequest alloc] initWithFields:self.fields
