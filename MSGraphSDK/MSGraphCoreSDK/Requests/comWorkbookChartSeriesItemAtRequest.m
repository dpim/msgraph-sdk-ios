...
@interface comWorkbookChartSeriesItemAtRequest()
...
@implementation comWorkbookChartSeriesItemAtRequest
...
- (MSURLSessionDataTask *)executeWithCompletion:(void (^)(comWorkbookChartSeries *response, NSError *error))completionHandler
{

    MSURLSessionDataTask *task = [self taskWithRequest:self.mutableRequest
                                odObjectWithDictionary:^(id responseObject){
                                                           return [[comWorkbookChartSeries alloc] initWithDictionary:responseObject];
                                                       }
