...
@implementation comGroupCalendarViewCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comGroupCalendarViewCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comGroupCalendarViewCollectionRequest *nextRequest = [[comGroupCalendarViewCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
