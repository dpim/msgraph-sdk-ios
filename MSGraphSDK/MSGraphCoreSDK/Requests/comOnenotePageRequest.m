...
@implementation comOnenotePageRequest
...
- (NSMutableURLRequest *)update:(comOnenotePage *)onenotePage
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[onenotePage dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:onenotePage]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comOnenotePage alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
