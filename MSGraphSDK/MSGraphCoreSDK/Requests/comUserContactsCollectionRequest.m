...
@implementation comUserContactsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comUserContactsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            return [[comContact alloc] initWithDictionary:response];
                                         }
                                                        completion:^(MSCollection *collectionResponse, NSError *error){
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comUserContactsCollectionRequest *nextRequest = [[comUserContactsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
...
- (NSMutableURLRequest *)addContact:(comContact*)contact
{
