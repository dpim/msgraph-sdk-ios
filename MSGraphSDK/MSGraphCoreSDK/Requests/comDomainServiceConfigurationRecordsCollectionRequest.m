...
@implementation comDomainServiceConfigurationRecordsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comDomainServiceConfigurationRecordsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            return [[comDomainDnsRecord alloc] initWithDictionary:response];
                                         }
                                                        completion:^(MSCollection *collectionResponse, NSError *error){
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comDomainServiceConfigurationRecordsCollectionRequest *nextRequest = [[comDomainServiceConfigurationRecordsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
...
- (NSMutableURLRequest *)addDomainDnsRecord:(comDomainDnsRecord*)domainDnsRecord
{
