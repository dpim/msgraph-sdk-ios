...
@implementation comWorkbookChartSeriesPointsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comWorkbookChartSeriesPointsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comWorkbookChartSeriesPointsCollectionRequest *nextRequest = [[comWorkbookChartSeriesPointsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
...
- (NSMutableURLRequest *)addWorkbookChartPoint:(comWorkbookChartPoint*)workbookChartPoint
{
