...
@interface comDirectoryObjectGetMemberObjectsRequest()
...
@implementation comDirectoryObjectGetMemberObjectsRequest
...
- (MSURLSessionDataTask *)executeWithCompletion:(void (^)(MSCollection *response, comDirectoryObjectGetMemberObjectsRequest *nextRequest, NSError *error))completionHandler
{
    ...
    MSURLSessionDataTask *task = [self collectionTaskWithRequest:self.mutableRequest
                                      ...
                                      if(!error && collectionResponse.nextLink && completionHandler){
                                              comDirectoryObjectGetMemberObjectsRequest *nextRequest = [[comDirectoryObjectGetMemberObjectsRequest alloc] initWithURL:collectionResponse.nextLink
                                                                                                                  options:nil
                                                                                                                  client:self.client];
