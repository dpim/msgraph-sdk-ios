...
@implementation comWorkbooksCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comWorkbooksCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comWorkbooksCollectionRequest *nextRequest = [[comWorkbooksCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
