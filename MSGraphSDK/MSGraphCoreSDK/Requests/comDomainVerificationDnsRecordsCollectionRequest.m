...
@implementation comDomainVerificationDnsRecordsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comDomainVerificationDnsRecordsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comDomainVerificationDnsRecordsCollectionRequest *nextRequest = [[comDomainVerificationDnsRecordsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
