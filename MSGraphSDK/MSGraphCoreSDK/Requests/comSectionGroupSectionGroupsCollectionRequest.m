...
@implementation comSectionGroupSectionGroupsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comSectionGroupSectionGroupsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comSectionGroupSectionGroupsCollectionRequest *nextRequest = [[comSectionGroupSectionGroupsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
