...
@implementation comWorkbookChartDataLabelFormatRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comWorkbookChartDataLabelFormat *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comWorkbookChartDataLabelFormat alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comWorkbookChartDataLabelFormat *)workbookChartDataLabelFormat
{
