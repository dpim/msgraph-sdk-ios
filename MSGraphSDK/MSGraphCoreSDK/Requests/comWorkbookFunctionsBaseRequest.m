...
@interface comWorkbookFunctionsBaseRequest()
...
@implementation comWorkbookFunctionsBaseRequest


- (instancetype)initWithNumber:(comJson *)number radix:(comJson *)radix minLength:(comJson *)minLength URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{
