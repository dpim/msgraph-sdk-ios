...
@implementation comWorkbookChartLineFormatRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comWorkbookChartLineFormat *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comWorkbookChartLineFormat alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comWorkbookChartLineFormat *)workbookChartLineFormat
{
