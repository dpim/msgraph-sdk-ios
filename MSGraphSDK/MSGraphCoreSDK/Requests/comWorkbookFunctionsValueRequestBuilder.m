...
@interface comWorkbookFunctionsValueRequestBuilder()
...
@implementation comWorkbookFunctionsValueRequestBuilder
...
- (comWorkbookFunctionsValueRequest *)requestWithOptions:(NSArray *)options
{
    ...
    return [[comWorkbookFunctionsValueRequest alloc] initWithText:self.text
                                                              URL:self.requestURL
                                                          options:options
                                                           client:self.client];
