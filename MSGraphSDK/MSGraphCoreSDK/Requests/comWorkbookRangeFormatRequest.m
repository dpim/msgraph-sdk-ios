...
@implementation comWorkbookRangeFormatRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comWorkbookRangeFormat *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comWorkbookRangeFormat alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comWorkbookRangeFormat *)workbookRangeFormat
{
