...
@interface comWorkbookFunctionsF_Dist_RTRequest()
...
@implementation comWorkbookFunctionsF_Dist_RTRequest


- (instancetype)initWithX:(comJson *)x degFreedom1:(comJson *)degFreedom1 degFreedom2:(comJson *)degFreedom2 URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{
