...
@interface comWorkbookFunctionsCoupNumRequestBuilder()
...
@implementation comWorkbookFunctionsCoupNumRequestBuilder
...
- (comWorkbookFunctionsCoupNumRequest *)requestWithOptions:(NSArray *)options
{
    ...
    return [[comWorkbookFunctionsCoupNumRequest alloc] initWithSettlement:self.settlement
