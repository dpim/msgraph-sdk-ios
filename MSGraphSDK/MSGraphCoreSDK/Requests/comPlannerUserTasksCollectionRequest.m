...
@implementation comPlannerUserTasksCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comPlannerUserTasksCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comPlannerUserTasksCollectionRequest *nextRequest = [[comPlannerUserTasksCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
