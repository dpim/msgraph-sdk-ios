...
@implementation comDirectoryRoleTemplatesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comDirectoryRoleTemplatesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            return [[comDirectoryRoleTemplate alloc] initWithDictionary:response];
                                         }
                                                        completion:^(MSCollection *collectionResponse, NSError *error){
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comDirectoryRoleTemplatesCollectionRequest *nextRequest = [[comDirectoryRoleTemplatesCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
...
- (NSMutableURLRequest *)addDirectoryRoleTemplate:(comDirectoryRoleTemplate*)directoryRoleTemplate
{
