...
@implementation comPlannerUserPlansCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comPlannerUserPlansCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comPlannerUserPlansCollectionRequest *nextRequest = [[comPlannerUserPlansCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
