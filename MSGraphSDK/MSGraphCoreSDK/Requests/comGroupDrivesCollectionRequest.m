...
@implementation comGroupDrivesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comGroupDrivesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comGroupDrivesCollectionRequest *nextRequest = [[comGroupDrivesCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
