...
@interface comWorkbookRangeClearRequest()
...
{
    NSDictionary *params = [[NSDictionary alloc] initWithObjectsAndKeys:[MSObject getNSJsonSerializationCompatibleValue:_applyTo],@"applyTo",nil];
