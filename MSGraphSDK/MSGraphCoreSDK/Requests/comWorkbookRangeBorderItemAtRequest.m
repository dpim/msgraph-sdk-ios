...
@interface comWorkbookRangeBorderItemAtRequest()
...
@implementation comWorkbookRangeBorderItemAtRequest
...
- (MSURLSessionDataTask *)executeWithCompletion:(void (^)(comWorkbookRangeBorder *response, NSError *error))completionHandler
{
    ...
    MSURLSessionDataTask *task = [self taskWithRequest:self.mutableRequest
                                odObjectWithDictionary:^(id responseObject){
                                                           return [[comWorkbookRangeBorder alloc] initWithDictionary:responseObject];
                                                       }
