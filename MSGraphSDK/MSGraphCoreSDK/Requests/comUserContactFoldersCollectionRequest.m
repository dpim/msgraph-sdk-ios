...
@implementation comUserContactFoldersCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comUserContactFoldersCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comUserContactFoldersCollectionRequest *nextRequest = [[comUserContactFoldersCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
