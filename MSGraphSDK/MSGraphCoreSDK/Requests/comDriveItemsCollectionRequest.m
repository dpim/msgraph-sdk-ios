...
@implementation comDriveItemsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comDriveItemsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comDriveItemsCollectionRequest *nextRequest = [[comDriveItemsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
