...
@interface comDirectoryObjectCheckMemberGroupsRequest()
...
@implementation comDirectoryObjectCheckMemberGroupsRequest
...
{
    NSDictionary *params = [[NSDictionary alloc] initWithObjectsAndKeys:[MSObject getNSJsonSerializationCompatibleValue:_groupIds],@"groupIds",nil];
...
- (MSURLSessionDataTask *)executeWithCompletion:(void (^)(MSCollection *response, comDirectoryObjectCheckMemberGroupsRequest *nextRequest, NSError *error))completionHandler
{
    ...
    MSURLSessionDataTask *task = [self collectionTaskWithRequest:self.mutableRequest
                                      ...
                                      if(!error && collectionResponse.nextLink && completionHandler){
                                              comDirectoryObjectCheckMemberGroupsRequest *nextRequest = [[comDirectoryObjectCheckMemberGroupsRequest alloc] initWithURL:collectionResponse.nextLink
                                                                                                                  options:nil
                                                                                                                  client:self.client];
