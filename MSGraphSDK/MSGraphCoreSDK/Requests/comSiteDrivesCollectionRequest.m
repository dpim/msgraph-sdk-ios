...
@implementation comSiteDrivesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comSiteDrivesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comSiteDrivesCollectionRequest *nextRequest = [[comSiteDrivesCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
