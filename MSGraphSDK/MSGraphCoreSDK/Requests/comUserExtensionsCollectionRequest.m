...
@implementation comUserExtensionsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comUserExtensionsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comUserExtensionsCollectionRequest *nextRequest = [[comUserExtensionsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
