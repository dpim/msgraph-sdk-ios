...
@interface comWorkbookChartSetPositionRequest()
...
@implementation comWorkbookChartSetPositionRequest


- (instancetype)initWithStartCell:(comJson *)startCell endCell:(comJson *)endCell URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{
