...
@implementation comWorkbookFormatProtectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comWorkbookFormatProtection *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comWorkbookFormatProtection alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comWorkbookFormatProtection *)workbookFormatProtection
{
