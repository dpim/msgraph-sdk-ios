...
@implementation comPlannerBucketTaskBoardTaskFormatRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comPlannerBucketTaskBoardTaskFormat *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comPlannerBucketTaskBoardTaskFormat alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comPlannerBucketTaskBoardTaskFormat *)plannerBucketTaskBoardTaskFormat
{
