...
@implementation comFieldValueSetRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comFieldValueSet *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comFieldValueSet alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comFieldValueSet *)fieldValueSet
{
