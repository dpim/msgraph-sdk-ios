...
@implementation comPlannerTaskDetailsRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comPlannerTaskDetails *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comPlannerTaskDetails alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comPlannerTaskDetails *)plannerTaskDetails
{
