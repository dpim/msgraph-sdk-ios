...
@implementation comUserEventsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comUserEventsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comUserEventsCollectionRequest *nextRequest = [[comUserEventsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
