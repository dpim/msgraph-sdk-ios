...
@implementation comPlannerTasksCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comPlannerTasksCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comPlannerTasksCollectionRequest *nextRequest = [[comPlannerTasksCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
