...
@interface comWorkbookFunctionsWeekdayRequest()
...
@implementation comWorkbookFunctionsWeekdayRequest


- (instancetype)initWithSerialNumber:(comJson *)serialNumber returnType:(comJson *)returnType URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{
