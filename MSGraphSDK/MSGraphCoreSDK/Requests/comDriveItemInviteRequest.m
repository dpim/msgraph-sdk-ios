...
@interface comDriveItemInviteRequest()
...
@implementation comDriveItemInviteRequest
...
- (MSURLSessionDataTask *)executeWithCompletion:(void (^)(MSCollection *response, comDriveItemInviteRequest *nextRequest, NSError *error))completionHandler
{
    ...
    MSURLSessionDataTask *task = [self collectionTaskWithRequest:self.mutableRequest
                                      ...
                                      if(!error && collectionResponse.nextLink && completionHandler){
                                              comDriveItemInviteRequest *nextRequest = [[comDriveItemInviteRequest alloc] initWithURL:collectionResponse.nextLink
                                                                                                                  options:nil
                                                                                                                  client:self.client];
