...
@implementation comNotebookSectionsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comNotebookSectionsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comNotebookSectionsCollectionRequest *nextRequest = [[comNotebookSectionsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
