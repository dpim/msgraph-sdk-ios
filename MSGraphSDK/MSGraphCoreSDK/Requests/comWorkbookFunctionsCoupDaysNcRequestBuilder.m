...
@interface comWorkbookFunctionsCoupDaysNcRequestBuilder()
...
@implementation comWorkbookFunctionsCoupDaysNcRequestBuilder
...
- (comWorkbookFunctionsCoupDaysNcRequest *)requestWithOptions:(NSArray *)options
{
    ...
    return [[comWorkbookFunctionsCoupDaysNcRequest alloc] initWithSettlement:self.settlement
