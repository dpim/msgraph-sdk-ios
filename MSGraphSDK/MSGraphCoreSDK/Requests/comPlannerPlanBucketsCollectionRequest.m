...
@implementation comPlannerPlanBucketsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comPlannerPlanBucketsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comPlannerPlanBucketsCollectionRequest *nextRequest = [[comPlannerPlanBucketsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
