...
@implementation comOnenoteSectionGroupsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comOnenoteSectionGroupsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comOnenoteSectionGroupsCollectionRequest *nextRequest = [[comOnenoteSectionGroupsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
