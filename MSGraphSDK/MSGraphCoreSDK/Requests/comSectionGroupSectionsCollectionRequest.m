...
@implementation comSectionGroupSectionsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comSectionGroupSectionsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comSectionGroupSectionsCollectionRequest *nextRequest = [[comSectionGroupSectionsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
