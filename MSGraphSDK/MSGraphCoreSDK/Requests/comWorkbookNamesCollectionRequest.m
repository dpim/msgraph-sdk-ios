...
@implementation comWorkbookNamesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comWorkbookNamesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comWorkbookNamesCollectionRequest *nextRequest = [[comWorkbookNamesCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
