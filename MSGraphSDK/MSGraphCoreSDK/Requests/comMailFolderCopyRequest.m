...
@interface comMailFolderCopyRequest()
...
@implementation comMailFolderCopyRequest
...
- (MSURLSessionDataTask *)executeWithCompletion:(void (^)(comMailFolder *response, NSError *error))completionHandler
{
