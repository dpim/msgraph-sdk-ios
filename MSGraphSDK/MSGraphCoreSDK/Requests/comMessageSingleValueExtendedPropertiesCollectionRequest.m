...
@implementation comMessageSingleValueExtendedPropertiesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comMessageSingleValueExtendedPropertiesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comMessageSingleValueExtendedPropertiesCollectionRequest *nextRequest = [[comMessageSingleValueExtendedPropertiesCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
