...
@implementation comDriveItemChildrenCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comDriveItemChildrenCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comDriveItemChildrenCollectionRequest *nextRequest = [[comDriveItemChildrenCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
