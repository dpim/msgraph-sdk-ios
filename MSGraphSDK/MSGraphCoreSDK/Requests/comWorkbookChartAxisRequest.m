...
@implementation comWorkbookChartAxisRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comWorkbookChartAxis *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comWorkbookChartAxis alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comWorkbookChartAxis *)workbookChartAxis
{
