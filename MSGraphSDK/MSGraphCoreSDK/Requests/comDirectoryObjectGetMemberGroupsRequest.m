...
@interface comDirectoryObjectGetMemberGroupsRequest()
...
@implementation comDirectoryObjectGetMemberGroupsRequest
...
- (MSURLSessionDataTask *)executeWithCompletion:(void (^)(MSCollection *response, comDirectoryObjectGetMemberGroupsRequest *nextRequest, NSError *error))completionHandler
{
    ...
    MSURLSessionDataTask *task = [self collectionTaskWithRequest:self.mutableRequest
                                      ...
                                      if(!error && collectionResponse.nextLink && completionHandler){
                                              comDirectoryObjectGetMemberGroupsRequest *nextRequest = [[comDirectoryObjectGetMemberGroupsRequest alloc] initWithURL:collectionResponse.nextLink
                                                                                                                  options:nil
                                                                                                                  client:self.client];
