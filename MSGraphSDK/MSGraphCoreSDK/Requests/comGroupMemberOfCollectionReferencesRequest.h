...
typedef void (^comGroupMemberOfCollectionReferencesCompletionHandler)(MSCollection *response, comGroupMemberOfCollectionReferencesRequest *nextRequest, NSError *error);

@interface comGroupMemberOfCollectionReferencesRequest : MSCollectionRequest
