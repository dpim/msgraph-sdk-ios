...
@implementation comDomainDnsUnavailableRecordRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comDomainDnsUnavailableRecord *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comDomainDnsUnavailableRecord alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comDomainDnsUnavailableRecord *)domainDnsUnavailableRecord
{
...
- (MSURLSessionDataTask *)update:(comDomainDnsUnavailableRecord *)domainDnsUnavailableRecord withCompletion:(void (^)(comDomainDnsUnavailableRecord *response, NSError *error))completionHandler
{
