...
@implementation comMessageAttachmentsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comMessageAttachmentsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            return [[comAttachment alloc] initWithDictionary:response];
                                         }
                                                        completion:^(MSCollection *collectionResponse, NSError *error){
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comMessageAttachmentsCollectionRequest *nextRequest = [[comMessageAttachmentsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
...
- (NSMutableURLRequest *)addAttachment:(comAttachment*)attachment
{
