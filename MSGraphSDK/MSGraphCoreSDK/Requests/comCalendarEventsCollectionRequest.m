...
@implementation comCalendarEventsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comCalendarEventsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comCalendarEventsCollectionRequest *nextRequest = [[comCalendarEventsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
