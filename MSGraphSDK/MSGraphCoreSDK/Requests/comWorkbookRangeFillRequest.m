...
@implementation comWorkbookRangeFillRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comWorkbookRangeFill *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comWorkbookRangeFill alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comWorkbookRangeFill *)workbookRangeFill
{
