...
@implementation comSchemaExtensionsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comSchemaExtensionsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comSchemaExtensionsCollectionRequest *nextRequest = [[comSchemaExtensionsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
...
- (NSMutableURLRequest *)addSchemaExtension:(comSchemaExtension*)schemaExtension
{
