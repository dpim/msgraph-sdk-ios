...
@implementation comPlannerBucketsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comPlannerBucketsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comPlannerBucketsCollectionRequest *nextRequest = [[comPlannerBucketsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
