...
@interface comWorkbookFunctionsNRequestBuilder()
...
@implementation comWorkbookFunctionsNRequestBuilder
...
- (comWorkbookFunctionsNRequest *)requestWithOptions:(NSArray *)options
{
    ...
    return [[comWorkbookFunctionsNRequest alloc] initWithValue:self.value
                                                           URL:self.requestURL
                                                       options:options
                                                        client:self.client];
