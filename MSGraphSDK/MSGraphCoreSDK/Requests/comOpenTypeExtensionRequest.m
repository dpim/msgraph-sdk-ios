...
@implementation comOpenTypeExtensionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comOpenTypeExtension *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comOpenTypeExtension alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comOpenTypeExtension *)openTypeExtension
{
