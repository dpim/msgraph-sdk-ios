...
@implementation comGroupSettingTemplateRequest
...
- (NSMutableURLRequest *)update:(comGroupSettingTemplate *)groupSettingTemplate
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[groupSettingTemplate dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:groupSettingTemplate]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comGroupSettingTemplate alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
