...
@interface comDriveItemCreateLinkRequest()
...
@implementation comDriveItemCreateLinkRequest
...
- (MSURLSessionDataTask *)executeWithCompletion:(void (^)(comPermission *response, NSError *error))completionHandler
{

    MSURLSessionDataTask *task = [self taskWithRequest:self.mutableRequest
                                odObjectWithDictionary:^(id responseObject){
                                                           return [[comPermission alloc] initWithDictionary:responseObject];
                                                       }
