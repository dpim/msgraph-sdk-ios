...
@implementation comEventAttachmentsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comEventAttachmentsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comEventAttachmentsCollectionRequest *nextRequest = [[comEventAttachmentsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
