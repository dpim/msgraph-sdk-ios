...
@implementation comOnenoteEntityBaseModelRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comOnenoteEntityBaseModel *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comOnenoteEntityBaseModel alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comOnenoteEntityBaseModel *)onenoteEntityBaseModel
{
