...
@implementation comSectionGroupSectionGroupsCollectionRequestBuilder : MSCollectionRequestBuilder
...
{
    return [[comSectionGroupSectionGroupsCollectionRequest alloc] initWithURL:self.requestURL options:options client:self.client];
}
