...
@implementation comWorkbookChartTitleRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comWorkbookChartTitle *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comWorkbookChartTitle alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comWorkbookChartTitle *)workbookChartTitle
{
