...
@implementation comWorkbookChartAreaFormatRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comWorkbookChartAreaFormat *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comWorkbookChartAreaFormat alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comWorkbookChartAreaFormat *)workbookChartAreaFormat
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[workbookChartAreaFormat dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:workbookChartAreaFormat]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comWorkbookChartAreaFormat alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
