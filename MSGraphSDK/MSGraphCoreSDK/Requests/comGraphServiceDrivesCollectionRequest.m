...
@implementation comDrivesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comDrivesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comDrivesCollectionRequest *nextRequest = [[comDrivesCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
