...
@implementation comOutlookItemRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comOutlookItem *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comOutlookItem alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comOutlookItem *)outlookItem
{
...
- (MSURLSessionDataTask *)update:(comOutlookItem *)outlookItem withCompletion:(void (^)(comOutlookItem *response, NSError *error))completionHandler
{
