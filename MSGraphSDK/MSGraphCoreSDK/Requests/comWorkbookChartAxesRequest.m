...
@implementation comWorkbookChartAxesRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comWorkbookChartAxes *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comWorkbookChartAxes alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comWorkbookChartAxes *)workbookChartAxes
{
