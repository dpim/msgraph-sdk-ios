...
@implementation comWorkbookChartAxisFormatRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comWorkbookChartAxisFormat *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comWorkbookChartAxisFormat alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comWorkbookChartAxisFormat *)workbookChartAxisFormat
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[workbookChartAxisFormat dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:workbookChartAxisFormat]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comWorkbookChartAxisFormat alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
