...
@implementation comItemAttachmentRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comItemAttachment *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comItemAttachment alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comItemAttachment *)itemAttachment
{
