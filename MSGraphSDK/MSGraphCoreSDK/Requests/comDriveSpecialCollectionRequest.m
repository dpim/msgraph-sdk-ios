...
@implementation comDriveSpecialCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comDriveSpecialCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comDriveSpecialCollectionRequest *nextRequest = [[comDriveSpecialCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
