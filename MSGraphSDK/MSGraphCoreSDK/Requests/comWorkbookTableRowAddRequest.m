...
@interface comWorkbookTableRowAddRequest()
...
@implementation comWorkbookTableRowAddRequest


- (instancetype)initWithIndex:(int32_t)index values:(comJson *)values URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{
...
- (MSURLSessionDataTask *)executeWithCompletion:(void (^)(comWorkbookTableRow *response, NSError *error))completionHandler
{
    ...
    MSURLSessionDataTask *task = [self taskWithRequest:self.mutableRequest
                                odObjectWithDictionary:^(id responseObject){
                                                           return [[comWorkbookTableRow alloc] initWithDictionary:responseObject];
                                                       }
