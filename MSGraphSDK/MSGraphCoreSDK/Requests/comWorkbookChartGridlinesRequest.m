...
@implementation comWorkbookChartGridlinesRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comWorkbookChartGridlines *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comWorkbookChartGridlines alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comWorkbookChartGridlines *)workbookChartGridlines
{
