...
@implementation comPermissionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comPermission *response, NSError *error))completionHandler
{
...
- (NSMutableURLRequest *)update:(comPermission *)permission
{
...
- (MSURLSessionDataTask *)update:(comPermission *)permission withCompletion:(void (^)(comPermission *response, NSError *error))completionHandler
{
