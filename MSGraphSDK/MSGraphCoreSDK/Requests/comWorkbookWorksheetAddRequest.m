...
@interface comWorkbookWorksheetAddRequest()
...
@implementation comWorkbookWorksheetAddRequest
...
- (MSURLSessionDataTask *)executeWithCompletion:(void (^)(comWorkbookWorksheet *response, NSError *error))completionHandler
{

    MSURLSessionDataTask *task = [self taskWithRequest:self.mutableRequest
                                odObjectWithDictionary:^(id responseObject){
                                                           return [[comWorkbookWorksheet alloc] initWithDictionary:responseObject];
                                                       }
