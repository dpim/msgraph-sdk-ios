...
@interface comWorkbookFunctionsPmtRequest()
...
@implementation comWorkbookFunctionsPmtRequest


- (instancetype)initWithRate:(comJson *)rate nper:(comJson *)nper pv:(comJson *)pv fv:(comJson *)fv type:(comJson *)type URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{
