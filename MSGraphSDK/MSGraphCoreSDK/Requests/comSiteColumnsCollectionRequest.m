...
@implementation comSiteColumnsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comSiteColumnsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comSiteColumnsCollectionRequest *nextRequest = [[comSiteColumnsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
...
- (NSMutableURLRequest *)addColumnDefinition:(comColumnDefinition*)columnDefinition
{
