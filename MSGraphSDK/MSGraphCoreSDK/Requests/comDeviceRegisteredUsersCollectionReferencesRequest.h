...
typedef void (^comDeviceRegisteredUsersCollectionReferencesCompletionHandler)(MSCollection *response, comDeviceRegisteredUsersCollectionReferencesRequest *nextRequest, NSError *error);

@interface comDeviceRegisteredUsersCollectionReferencesRequest : MSCollectionRequest
