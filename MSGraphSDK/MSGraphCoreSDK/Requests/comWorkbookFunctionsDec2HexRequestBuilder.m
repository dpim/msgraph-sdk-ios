...
@interface comWorkbookFunctionsDec2HexRequestBuilder()
...
@implementation comWorkbookFunctionsDec2HexRequestBuilder
...
- (comWorkbookFunctionsDec2HexRequest *)requestWithOptions:(NSArray *)options
{
    ...
    return [[comWorkbookFunctionsDec2HexRequest alloc] initWithNumber:self.number
                                                               places:self.places
                                                                  URL:self.requestURL
                                                              options:options
                                                               client:self.client];
