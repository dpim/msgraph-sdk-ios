...
@implementation comFileAttachmentRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comFileAttachment *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comFileAttachment alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comFileAttachment *)fileAttachment
{
