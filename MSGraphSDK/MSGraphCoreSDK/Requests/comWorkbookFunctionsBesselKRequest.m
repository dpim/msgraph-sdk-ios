...
@interface comWorkbookFunctionsBesselKRequest()
...
@implementation comWorkbookFunctionsBesselKRequest


- (instancetype)initWithX:(comJson *)x n:(comJson *)n URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{
