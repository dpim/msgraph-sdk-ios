...
@implementation comOnenoteOperationsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comOnenoteOperationsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comOnenoteOperationsCollectionRequest *nextRequest = [[comOnenoteOperationsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
...
- (NSMutableURLRequest *)addOnenoteOperation:(comOnenoteOperation*)onenoteOperation
{
