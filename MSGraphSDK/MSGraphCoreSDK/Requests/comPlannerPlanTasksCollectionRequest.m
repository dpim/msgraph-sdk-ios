...
@implementation comPlannerPlanTasksCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comPlannerPlanTasksCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comPlannerPlanTasksCollectionRequest *nextRequest = [[comPlannerPlanTasksCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
