...
@implementation comOrganizationExtensionsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comOrganizationExtensionsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comOrganizationExtensionsCollectionRequest *nextRequest = [[comOrganizationExtensionsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
