...
@implementation comContactSingleValueExtendedPropertiesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comContactSingleValueExtendedPropertiesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comContactSingleValueExtendedPropertiesCollectionRequest *nextRequest = [[comContactSingleValueExtendedPropertiesCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
