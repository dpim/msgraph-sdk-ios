...
@implementation comListColumnsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comListColumnsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comListColumnsCollectionRequest *nextRequest = [[comListColumnsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
