...
@implementation comPlannerPlansCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comPlannerPlansCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comPlannerPlansCollectionRequest *nextRequest = [[comPlannerPlansCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
