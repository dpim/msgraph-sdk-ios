...
@interface comWorkbookWorksheetProtectionProtectRequest()
...
@implementation comWorkbookWorksheetProtectionProtectRequest
...
{
    NSDictionary *params = [[NSDictionary alloc] initWithObjectsAndKeys:[MSObject getNSJsonSerializationCompatibleValue:_options],@"options",nil];
