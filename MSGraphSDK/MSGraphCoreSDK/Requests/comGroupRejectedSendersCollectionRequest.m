...
@implementation comGroupRejectedSendersCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comGroupRejectedSendersCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comGroupRejectedSendersCollectionRequest *nextRequest = [[comGroupRejectedSendersCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
