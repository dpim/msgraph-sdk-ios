...
@implementation comPostExtensionsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comPostExtensionsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comPostExtensionsCollectionRequest *nextRequest = [[comPostExtensionsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
