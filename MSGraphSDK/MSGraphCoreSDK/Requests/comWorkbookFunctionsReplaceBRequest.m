...
@interface comWorkbookFunctionsReplaceBRequest()
...
@implementation comWorkbookFunctionsReplaceBRequest


- (instancetype)initWithOldText:(comJson *)oldText startNum:(comJson *)startNum numBytes:(comJson *)numBytes newText:(comJson *)newText URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{
