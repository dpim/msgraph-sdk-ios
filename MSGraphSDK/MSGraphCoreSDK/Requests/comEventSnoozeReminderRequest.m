...
@interface comEventSnoozeReminderRequest()
...
@implementation comEventSnoozeReminderRequest


- (instancetype)initWithNewReminderTime:(comDateTimeTimeZone *)newReminderTime URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{
