...
typedef void (^comGroupOwnersCollectionReferencesCompletionHandler)(MSCollection *response, comGroupOwnersCollectionReferencesRequest *nextRequest, NSError *error);

@interface comGroupOwnersCollectionReferencesRequest : MSCollectionRequest
