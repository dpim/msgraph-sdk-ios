...
@implementation comGroupEventsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comGroupEventsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comGroupEventsCollectionRequest *nextRequest = [[comGroupEventsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
