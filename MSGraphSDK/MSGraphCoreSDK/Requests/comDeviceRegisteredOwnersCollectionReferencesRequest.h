...
typedef void (^comDeviceRegisteredOwnersCollectionReferencesCompletionHandler)(MSCollection *response, comDeviceRegisteredOwnersCollectionReferencesRequest *nextRequest, NSError *error);

@interface comDeviceRegisteredOwnersCollectionReferencesRequest : MSCollectionRequest
