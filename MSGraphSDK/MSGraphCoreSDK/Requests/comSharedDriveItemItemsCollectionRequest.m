...
@implementation comSharedDriveItemItemsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comSharedDriveItemItemsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            return [[comDriveItem alloc] initWithDictionary:response];
                                         }
                                                        completion:^(MSCollection *collectionResponse, NSError *error){
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comSharedDriveItemItemsCollectionRequest *nextRequest = [[comSharedDriveItemItemsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
...
- (NSMutableURLRequest *)addDriveItem:(comDriveItem*)driveItem
{
