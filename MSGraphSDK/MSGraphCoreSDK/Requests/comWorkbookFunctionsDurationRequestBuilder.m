...
@interface comWorkbookFunctionsDurationRequestBuilder()
...
@implementation comWorkbookFunctionsDurationRequestBuilder
...
- (comWorkbookFunctionsDurationRequest *)request
{
    return [self requestWithOptions:nil];
}

- (comWorkbookFunctionsDurationRequest *)requestWithOptions:(NSArray *)options
{

    return [[comWorkbookFunctionsDurationRequest alloc] initWithSettlement:self.settlement
