...
@implementation comWorkbookChartLegendRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comWorkbookChartLegend *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comWorkbookChartLegend alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comWorkbookChartLegend *)workbookChartLegend
{
