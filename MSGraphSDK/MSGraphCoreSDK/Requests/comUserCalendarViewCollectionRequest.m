...
@implementation comUserCalendarViewCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comUserCalendarViewCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comUserCalendarViewCollectionRequest *nextRequest = [[comUserCalendarViewCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
