...
@interface comWorkbookFunctionsDstDevPRequestBuilder()
...
@implementation comWorkbookFunctionsDstDevPRequestBuilder
...
- (comWorkbookFunctionsDstDevPRequest *)requestWithOptions:(NSArray *)options
{
    ...
    return [[comWorkbookFunctionsDstDevPRequest alloc] initWithDatabase:self.database
                                                                  field:self.field
