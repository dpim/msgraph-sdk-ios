...
@interface comWorkbookRangeViewItemAtRequest()
...
@implementation comWorkbookRangeViewItemAtRequest
...
- (MSURLSessionDataTask *)executeWithCompletion:(void (^)(comWorkbookRangeView *response, NSError *error))completionHandler
{
    ...
    MSURLSessionDataTask *task = [self taskWithRequest:self.mutableRequest
                                odObjectWithDictionary:^(id responseObject){
                                                           return [[comWorkbookRangeView alloc] initWithDictionary:responseObject];
                                                       }
