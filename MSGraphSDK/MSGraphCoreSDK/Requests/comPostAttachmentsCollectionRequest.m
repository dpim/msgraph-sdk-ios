...
@implementation comPostAttachmentsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comPostAttachmentsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comPostAttachmentsCollectionRequest *nextRequest = [[comPostAttachmentsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
