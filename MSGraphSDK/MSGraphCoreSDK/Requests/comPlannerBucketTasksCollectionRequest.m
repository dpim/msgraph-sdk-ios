...
@implementation comPlannerBucketTasksCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comPlannerBucketTasksCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comPlannerBucketTasksCollectionRequest *nextRequest = [[comPlannerBucketTasksCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
