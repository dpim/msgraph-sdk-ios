...
@implementation comMailFolderChildFoldersCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comMailFolderChildFoldersCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            return [[comMailFolder alloc] initWithDictionary:response];
                                         }
                                                        completion:^(MSCollection *collectionResponse, NSError *error){
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comMailFolderChildFoldersCollectionRequest *nextRequest = [[comMailFolderChildFoldersCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
...
- (NSMutableURLRequest *)addMailFolder:(comMailFolder*)mailFolder
{
