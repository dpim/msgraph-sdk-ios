...
@interface comWorkbookFunctionsCumIPmtRequestBuilder()
...
@implementation comWorkbookFunctionsCumIPmtRequestBuilder
...
- (comWorkbookFunctionsCumIPmtRequest *)requestWithOptions:(NSArray *)options
{
    ...
    return [[comWorkbookFunctionsCumIPmtRequest alloc] initWithRate:self.rate
                                                               nper:self.nper
                                                                 pv:self.pv
