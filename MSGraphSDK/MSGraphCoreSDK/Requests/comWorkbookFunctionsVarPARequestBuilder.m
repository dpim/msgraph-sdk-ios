...
@interface comWorkbookFunctionsVarPARequestBuilder()
...
@implementation comWorkbookFunctionsVarPARequestBuilder
...
- (comWorkbookFunctionsVarPARequest *)requestWithOptions:(NSArray *)options
{
    ...
    return [[comWorkbookFunctionsVarPARequest alloc] initWithValues:self.values
                                                                URL:self.requestURL
                                                            options:options
                                                             client:self.client];
