...
@interface comWorkbookFunctionsIsNonTextRequest()
...
@implementation comWorkbookFunctionsIsNonTextRequest


- (instancetype)initWithValue:(comJson *)value URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{
