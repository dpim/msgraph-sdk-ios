...
@implementation comWorkbookTablesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comWorkbookTablesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comWorkbookTablesCollectionRequest *nextRequest = [[comWorkbookTablesCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
