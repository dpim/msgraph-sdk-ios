...
@implementation comWorkbookChartLegendFormatRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comWorkbookChartLegendFormat *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comWorkbookChartLegendFormat alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comWorkbookChartLegendFormat *)workbookChartLegendFormat
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[workbookChartLegendFormat dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:workbookChartLegendFormat]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comWorkbookChartLegendFormat alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
