...
@implementation comWorkbookChartAxisTitleRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comWorkbookChartAxisTitle *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comWorkbookChartAxisTitle alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comWorkbookChartAxisTitle *)workbookChartAxisTitle
{
