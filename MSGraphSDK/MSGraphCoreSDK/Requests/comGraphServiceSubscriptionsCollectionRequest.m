...
@implementation comSubscriptionsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comSubscriptionsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comSubscriptionsCollectionRequest *nextRequest = [[comSubscriptionsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
...
- (NSMutableURLRequest *)addSubscription:(comSubscription*)subscription
{
