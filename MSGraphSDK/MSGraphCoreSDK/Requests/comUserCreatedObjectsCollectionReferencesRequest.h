...
typedef void (^comUserCreatedObjectsCollectionReferencesCompletionHandler)(MSCollection *response, comUserCreatedObjectsCollectionReferencesRequest *nextRequest, NSError *error);

@interface comUserCreatedObjectsCollectionReferencesRequest : MSCollectionRequest
