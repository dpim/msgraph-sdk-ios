...
@implementation comUserMailFoldersCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comUserMailFoldersCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comUserMailFoldersCollectionRequest *nextRequest = [[comUserMailFoldersCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
