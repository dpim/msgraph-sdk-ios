...
@interface comWorkbookFunctionsDgetRequestBuilder()
...
@implementation comWorkbookFunctionsDgetRequestBuilder
...
- (comWorkbookFunctionsDgetRequest *)requestWithOptions:(NSArray *)options
{
    ...
    return [[comWorkbookFunctionsDgetRequest alloc] initWithDatabase:self.database
                                                               field:self.field
