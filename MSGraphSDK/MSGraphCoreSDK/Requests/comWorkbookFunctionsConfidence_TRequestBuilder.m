...
@interface comWorkbookFunctionsConfidence_TRequestBuilder()
...
@implementation comWorkbookFunctionsConfidence_TRequestBuilder
...
- (comWorkbookFunctionsConfidence_TRequest *)requestWithOptions:(NSArray *)options
{
    ...
    return [[comWorkbookFunctionsConfidence_TRequest alloc] initWithAlpha:self.alpha
