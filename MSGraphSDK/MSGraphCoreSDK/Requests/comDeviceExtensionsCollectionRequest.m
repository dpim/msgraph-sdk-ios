...
@implementation comDeviceExtensionsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comDeviceExtensionsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comDeviceExtensionsCollectionRequest *nextRequest = [[comDeviceExtensionsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
