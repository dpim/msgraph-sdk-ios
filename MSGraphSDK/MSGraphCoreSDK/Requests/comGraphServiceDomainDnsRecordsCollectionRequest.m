...
@implementation comDomainDnsRecordsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(comDomainDnsRecordsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                comDomainDnsRecordsCollectionRequest *nextRequest = [[comDomainDnsRecordsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
