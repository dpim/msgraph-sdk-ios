...
@implementation comInferenceClassificationRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(comInferenceClassification *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[comInferenceClassification alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(comInferenceClassification *)inferenceClassification
{
