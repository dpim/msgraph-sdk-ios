...
@interface comWorkbookChartPointItemAtRequest()
...
@implementation comWorkbookChartPointItemAtRequest
...
- (MSURLSessionDataTask *)executeWithCompletion:(void (^)(comWorkbookChartPoint *response, NSError *error))completionHandler
{

    MSURLSessionDataTask *task = [self taskWithRequest:self.mutableRequest
                                odObjectWithDictionary:^(id responseObject){
                                                           return [[comWorkbookChartPoint alloc] initWithDictionary:responseObject];
                                                       }
