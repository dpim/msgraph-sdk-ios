...
@interface comWorkbookFunctionsDcountARequestBuilder()
...
@implementation comWorkbookFunctionsDcountARequestBuilder
...
- (comWorkbookFunctionsDcountARequest *)requestWithOptions:(NSArray *)options
{
    ...
    return [[comWorkbookFunctionsDcountARequest alloc] initWithDatabase:self.database
                                                                  field:self.field
