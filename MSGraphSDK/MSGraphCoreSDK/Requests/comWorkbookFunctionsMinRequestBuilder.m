...
@interface comWorkbookFunctionsMinRequestBuilder()
...
@implementation comWorkbookFunctionsMinRequestBuilder
...
- (comWorkbookFunctionsMinRequest *)requestWithOptions:(NSArray *)options
{
    ...
    return [[comWorkbookFunctionsMinRequest alloc] initWithValues:self.values
                                                              URL:self.requestURL
                                                          options:options
                                                           client:self.client];
